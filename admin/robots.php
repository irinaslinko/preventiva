...
if ($request->GetProperty("Save") == 1)
{
	...
	if($currentDomain)
		$fp = fopen(PROJECT_DIR."website/".WEBSITE_FOLDER."/".$currentDomain.".robots.txt", "w");
	else 
...
else 
{
	...
	if($currentDomain)
		$robotsContent = file_get_contents(PROJECT_DIR."website/".WEBSITE_FOLDER."/".$currentDomain.".robots.txt");
	else 
